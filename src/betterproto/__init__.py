...
class Message(ABC):
    ...
    def dump(
        self, stream: "SupportsWrite[bytes]", delimit: Optional[SIZE_DELIMITED] = None
    ) -> None:
        """
    ...
    def load(
        ...
        size: Optional[Union[int, SIZE_DELIMITED]] = None,
    ) -> T:
        """
        ...
        delimited: :class:`bool`
            Whether the message is delimited (and should be parsed as such).
