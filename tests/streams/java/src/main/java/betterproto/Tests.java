...
public class Tests {
    public void testSingleVarint() throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream("tests/output_streams/py_single_varint.out");
        ...
        FileOutputStream outputStream = new FileOutputStream("tests/output_streams/java_single_varint.out");
    ...
    public void testMultipleVarints() throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream("tests/output_streams/py_multiple_varints.out");
        CodedInputStream codedInput = CodedInputStream.newInstance(inputStream);
        ...
        FileOutputStream outputStream = new FileOutputStream("tests/output_streams/java_multiple_varints.out");
        CodedOutputStream codedOutput = CodedOutputStream.newInstance(outputStream);
    ...
    public void testSingleMessage() throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream("tests/output_streams/py_single_message.out");
        CodedInputStream codedInput = CodedInputStream.newInstance(inputStream);
        ...
        FileOutputStream outputStream = new FileOutputStream("tests/output_streams/java_single_message.out");
        CodedOutputStream codedOutput = CodedOutputStream.newInstance(outputStream);
    ...
    public void testMultipleMessages() throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream("tests/output_streams/py_multiple_messages.out");
        ...
        FileOutputStream outputStream = new FileOutputStream("tests/output_streams/java_multiple_messages.out");
